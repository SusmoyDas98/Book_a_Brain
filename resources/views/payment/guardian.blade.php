...
<div class="container" style="max-width:1100px;">
    ...
    {{-- SECTION 3: TUITION PAYMENT HISTORY --}}
    <div style="background:white;border:2px solid #e2e8f0;border-radius:24px;padding:1.5rem;box-shadow:0 4px 15px rgba(0,0,0,0.05);">
        <p style="font-weight:800;color:#0f172a;font-size:1rem;margin-bottom:1rem;">
            <i class="bi bi-book me-2" style="color:#6366f1;"></i>Tuition Payment History
        </p>
        <div style="overflow-x:auto;">
            <table style="width:100%;border-collapse:collapse;font-size:0.83rem;">
                <thead>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #f8fafc;transition:0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding:0.65rem 0.75rem;font-weight:700;color:#0f172a;">BDT {{ number_format($tp->amount, 2) }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="8" style="padding:2rem;text-align:center;color:#94a3b8;font-size:0.85rem;">No tuition payment history found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
