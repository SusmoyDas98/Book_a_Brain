...
<head>
    ...
    <title>bKash — Payment Failed</title>
    @php
...
<body>
    <div class="bkash-wrapper">
        ...
        <div class="bkash-card">
            ...
            <h1 class="card-heading">Payment Failed</h1>
            <p class="card-subtext">Your PIN was incorrect. The payment could not be completed.</p>
