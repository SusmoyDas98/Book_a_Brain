...
<head>
    ...
    <title>bKash — Verification Code</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-subtext { font-size: 0.82rem; color: #888; text-align: center; margin-bottom: 1.5rem; }
...
<body>
    <div class="bkash-wrapper">
        ...
        <div class="bkash-card">
            ...
            <h1 class="card-heading">Enter Verification Code</h1>
            <p class="card-subtext">A verification code has been sent to your number</p>

            <form method="POST" action="{{ route('bkash.portal.otp.submit') }}">
                @csrf
                <div class="form-group">
                    <label class="form-label" for="otp">Verification Code (OTP)</label>
                    <input
                        type="text"
                        id="otp"
                        name="otp"
                    ...
                    @enderror
                    <p class="hint-text">Demo OTP: 1234</p>
                </div>
